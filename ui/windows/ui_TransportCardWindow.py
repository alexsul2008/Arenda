...
################################################################################
## Form generated from reading UI file 'TransportCardWindowHbgdYv.ui'
##
...
class Ui_TransportCardWindow(object):
    def setupUi(self, TransportCardWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/Icons/icons/refresh-ccw_.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_image_upload.setIcon(icon)
        ...
        self.technical_info_layout.setContentsMargins(10, 10, 0, -1)
        ...
        self.le_engine_volume.setMinimumSize(QSize(100, 26))
        self.le_engine_volume.setMaximumSize(QSize(100, 16777215))
        ...
        self.lbl_id_status.setMinimumSize(QSize(20, 0))
        self.lbl_id_status.setMaximumSize(QSize(20, 16777215))
